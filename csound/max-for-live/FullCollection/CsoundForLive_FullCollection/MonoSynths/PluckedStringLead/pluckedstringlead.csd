...
aout1 pluck gkenv*giamp, kfrq1+klfo, i(kfrq1), i(gkfn), i(gkmeth), 1, 0
aout2 pluck gkenv*giamp, kfrq2+klfo, i(kfrq2), i(gkfn), i(gkmeth), 1, 0
...
;;Spread Section:
aoutL = ((aout1 * gkspread) + (aout2 * (1 - gkspread))) *.75  
aoutR = ((aout1 * (1-gkspread)) + (aout2 * gkspread))   *.75
