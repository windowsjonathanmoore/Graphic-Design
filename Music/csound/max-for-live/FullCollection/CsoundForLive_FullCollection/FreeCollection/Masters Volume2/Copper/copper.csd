...
k1             phasor    gkp4, 0                            
k2             table3     k1 * ifuncl, 19, 0, 0, 1                      

anoise         rand      .1                       
k3             expsegr   ifrq*8+0.001, i(gkp3)+0.001, i(gkp6)+0.001, 1, i(gkp6)+0.001, 0.001, 0.001                         
a1             butterbp  anoise, k3 * k2, (k3 * gkp7)+0.0001, 1

kmgate         madsr i(gkatt), i(gkdec), i(gksus), i(gkrel)
kenv madsr .1, 1, 1, i(gkrel)
asig           =         a1 * kmgate *iamp *kenv
               asig = asig* 6
               asig clip asig, 0, .99
               outs      asig, asig
garvb          =         garvb + (asig * gkp8)
               endin
