...
namespace LSCollections
{
	...
	{        
        ...
        private bool Search(object key, out Node curr, Node[] update)
        {
            ...
            if(key == null)
            {
                var msg = resManager.GetString("NullKey");
            ...
            Node[] update)
        {
            ...
            found |= (curr != header && comparer.Compare(key, curr.entry.Key) == 0);
        ...
        {            
            ...
            {
                var msg = resManager.GetString("ComparableError");
            ...
            // If we haven't reached the end of the skip list and the 
            // current key is equal to the search key.
            found |= (curr != header && comp.CompareTo(key) == 0);
        ...
        {  
            ...
            public DictionaryEntry Entry
            {
                get
                {
                    ...
                    {
                        var msg = list.resManager.GetString("InvalidEnum");
                    ...
                    {
                        var msg = list.resManager.GetString("BadEnumAccess");                        
        ...
        public void Add(object key, object value)
        {
            ...
            {
                var msg = resManager.GetString("KeyExistsAdd");
                throw new ArgumentException(msg);
            }
        }
        ...
        public void CopyTo(Array array, int index)
        {
            ...
            if(array == null)
            {
                var msg = resManager.GetString("NullArrayCopyTo");
                throw new ArgumentNullException(msg);
            }
            // Make sure index is not negative.
            else if(index < 0)
            {
                var msg = resManager.GetString("BadIndexCopyTo");
