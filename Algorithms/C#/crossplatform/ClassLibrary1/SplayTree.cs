...
namespace algorithms
{
	...
	public class SplayTree
	{
		...
		public virtual Comparable find(Comparable x)
		{
			...
			if (Empty || root.element.compareTo(x) != 0)
				return null;
		...
		internal static BinaryNode rotateWithLeftChild(BinaryNode k2)
		{
		...
		internal static BinaryNode rotateWithRightChild(BinaryNode k1)
		{
