...
\[Missing <summary> documentation for "T:algorithms.Underflow"\]


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;algorithms.Underflow<br />
...
**VB Usage**<br />
``` VB Usage
Dim instance As Underflow
```

**C++**<br />
``` C++
[SerializableAttribute]
public ref class Underflow : public Exception
```
...
Type.createClass(
	'algorithms.Underflow',
	Exception);
```

The Underflow type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="ca566bbc-1d2b-96f4-9970-8f167c6b8350">Underflow</a></td><td>
Initializes a new instance of the Underflow class</td></tr></table>&nbsp;
<a href="#underflow-class">Back to Top</a>
